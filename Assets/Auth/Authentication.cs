...
public class Authentication : MonoBehaviour
{
    ...
    void EnableScripts()
    {
        gameObject.GetComponent<RealTimeDatabase>().enabled = true;
        gameObject.GetComponent<LoadImage>().enabled = true;
    }
    ...
    public string _userUID, _userDN;
            ...
            else
            {
                ...
                if (User != null)
                {
                    ...
                    else
                    {
                        ...
                        RealTimeDatabase.instance.CreateUser(User.DisplayName, User.UserId);
                        _userUID = User.UserId;
                        _userDN = User.DisplayName;
